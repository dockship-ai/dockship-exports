...
export class Backend implements backendInterface {
    ...
    async getSubmission(arg0: bigint): Promise<ContactSubmission | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContactSubmission]): ContactSubmission | null {
